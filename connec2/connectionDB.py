...
class ConnectionDB(object):
    ...
    def executeOneQuery(self, preSentencia,toRead):
        try:
...
if __name__ == '__main__':
    conex = ConnectionDB()
    #sentencia = """INSERT INTO jugador (id,nombre,apellido,edad,salario) VALUES  (%s)(""", 4, "pedro", "casas","(%s)", 30 , "(%s)", 500 , """)"""
    #preSentencia = """INSERT INTO jugador (id,nombre,apellido,edad,salario) VALUES (%s,%s,%s,%s,%s)"""
    #toInsert = (2, 'lalo', 'kota', 50, 500)
    #conex.execute(preSentencia,toInsert)

    print(conex.executeQuery("""SELECT * FROM jugador WHERE id = 1"""))
